...
output "active_gate_instance_profile_name" {
  value       = aws_iam_instance_profile.active_gate_instance_profile.name
  description = "Name of the IAM instance profile for the ActiveGate"
}
